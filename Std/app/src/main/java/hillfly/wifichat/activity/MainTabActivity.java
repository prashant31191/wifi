...
import hillfly.wifichat.activity.maintabs.ConnectionFragment;
...
public class MainTabActivity extends BaseActivity implements ActionBar.TabListener,
    ...
    private long ExitTime; // å»¶æ—¶é€€å‡ºæ—¶é—´åDEFAULT˜é‡DEFAULT
    ...
    protected void initEvents() {
        ...
        fragments.add(new ConnectionFragment(mContext));
        ...
        mViewPager.setOffscreenPageLimit(4); // ç¼“å­˜ä¸‰ä¸ªfragment
        ...
        for (int i = 0; i < 4; i++) {
            ...
            mBadgeView.hide(); // é»˜è®¤éšDEFAULTè—DEFAULT
            ...
            switch (i) {
                ...
                case 2:
                	tvTabText.setText(getString(R.string.maintab_text_connected));
                    break;
                case 3:
    ...
    public Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case IPMSGConst.IPMSG_BR_ENTRY: // ç”¨æˆ·ä¸Šçº¿
                case IPMSGConst.IPMSG_BR_EXIT: // ç”¨æˆ·ä¸‹çº¿
                    FriendsFragment v1 = (FriendsFragment) (mPagerAdapter).getItem(0);
                    v1.initMaptoList();
                    v1.refreshAdapter();
                    break;

                case IPMSGConst.IPMSG_RECVMSG: // æ”¶åˆ°æ–°æ¶ˆæDEFAULT¯
                case IPMSGConst.IPMSG_READMSG: // æ‰“å¼€æ–°æ¶ˆæDEFAULT¯
                    if (mBadgeView == null) {
                        mBadgeView = (BadgeView) mActionBar.getTabAt(1).getCustomView()
                                .findViewById(R.id.tab_badge);
                    }
