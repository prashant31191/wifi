...
public class BaseApplication extends Application {
    ...
    public void onCreate() {
        ...
        ActivitiesManager.init(getApplicationContext()); // Initialize the activity manager
        LogUtils.setLogStatus(isPrintLog); // Set up Whether to display the log
    ...
    /**
     * New message reminder - Voice reminder、振动提醒
     */
